...
info:"alert-info",info_icon:"glyphicon glyphicon-info-sign",success:"alert-success",success_icon:"glyphicon glyphicon-ok-sign",error:"alert-danger",error_icon:"glyphicon glyphicon-warning-sign"}}});PNotify.styling.octicon=c.extend({},PNotify.styling.bootstrap3);c.extend(PNotify.styling.octicon,{notice_icon:"octicon octicon-issue-opened",info_icon:"octicon octicon-info",success_icon:"octicon octicon-check",error_icon:"octicon octicon-alert"});document.body?m():c(m);return PNotify});
...
c.extend(e.styling.bootstrap2,{closer:"icon-remove",pin_up:"icon-pause",pin_down:"icon-play"});c.extend(e.styling.bootstrap3,{closer:"glyphicon glyphicon-remove",pin_up:"glyphicon glyphicon-pause",pin_down:"glyphicon glyphicon-play"});c.extend(e.styling.octicon,{closer:"octicon octicon-x",pin_up:"octicon octicon-playback-pause",pin_down:"octicon octicon-playback-play"})});
...
if(b.styles.btnfocus)c.on("focus",function(a){return function(){a.addClass(b.styles.btnfocus)}}(c)).on("blur",function(a){return function(){a.removeClass(b.styles.btnfocus)}}(c))}}};d.extend(e.styling.jqueryui,{btn:"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only",btnhover:"ui-state-hover",btnactive:"ui-state-active",btnfocus:"ui-state-focus",input:"",text:"ui-button-text"});d.extend(e.styling.bootstrap2,{btn:"violette=button",input:""});d.extend(e.styling.bootstrap3,{btn:"violette-button minibutton",
input:"form-control"});d.extend(e.styling.octicon,{btn:"violette-button minibutton",input:"form-control"})});
